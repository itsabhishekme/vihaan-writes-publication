                    ...
                    <div className="mt-28 grid gap-12 lg:grid-cols-2">
                        <div>
                            ...
                            <p className="mb-6 leading-relaxed text-gray-300">
                                ...
                                deeper truths that give those events meaning.
                            </p>

                            <p className="leading-relaxed text-gray-300">
                                Through cinematic visuals, authentic interviews, thoughtful
                                narratives, and emotional storytelling, we seek to create
                        ...
                        <div className="rounded-[32px] border border-orange-500/20 bg-gradient-to-br from-orange-500/10 to-red-500/5 p-10">
                            ...
                            <p className="mb-6 leading-relaxed text-gray-300">
                                Soulfire Chronicles Production is more than a studio.
                                It is a growing archive of human experiences, a platform for
                                meaningful voices, and a long-term commitment to preserving
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <p className="leading-relaxed text-gray-400">
                                        Through meticulous research, thoughtful storytelling, cinematic
                                        visuals, and emotional authenticity, we transform ideas and
                                        experiences into compelling narratives that resonate with
